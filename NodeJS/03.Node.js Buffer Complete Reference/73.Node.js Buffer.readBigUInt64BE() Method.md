O método Buffer.readBigUInt64BE() é usado para ler um inteiro de 64 bits sem sinal de um objeto buffer em um determinado deslocamento e retorna o resultado em Big endian.
Sintaxe:
```
...
Valor de retorno: Esse método lê um inteiro sem sinal de 64 bits no deslocamento especificado em Big endian.
### Exemplo 1: 
...
Referência: https://nodejs.org/dist/latest-v12.x/docs/api/buffer.html#buffer_buf_readbiguint64be_offset
