O método Buffer.readIntLE() é usado para ler o número de bytes de um buffer em um determinado deslocamento e interpreta o resultado como um valor assinado de complemento de dois. 
Sintaxe:
```
